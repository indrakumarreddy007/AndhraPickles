...
export default async function handler(req: VercelRequest, res: VercelResponse) {
    ...
    try {
        ...
        SELECT id, name, price, image, "spiceLevel", tag FROM products WHERE id = ${id}
      `;
        ...
        UPDATE products SET name=${name}, price=${price}, image=${image}, "spiceLevel"=${level}, tag=${tag}
        WHERE id=${id} RETURNING id, name, price, image, "spiceLevel", tag
      `;
